...
<header>
        ...
        <div class="del-pro">
            ...
            <div class="tab-size">
                <img src="/3D_SHOP/resources/img/banner/size3.jpg" alt="">
            </div>
            </c:forEach>
        </div>
    </div>
...
<footer>
        <div class="footer-cont">
            <container><img src="${pageContext.request.contextPath}/resources/img/logo/gamming_room.jpeg" width ="280" height ="280" alt=""> </container>
            <ul>
                Sản phẩm
