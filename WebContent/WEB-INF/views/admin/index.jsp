...
<body>
    ...
    <div class="main">
        <div class="main-left">
            <h1>${tb}</h1>
            <form class="add-pr" action="3D_SHOP/admin/gr-product.htm"  method="post">
            ...
            <form  class="add-pr" action="3D_SHOP/admin/product.htm" method="POST" enctype="multipart/form-data">
            	<h1>Thêm sản phẩm</h1>
			        <div class="input-fm">
            ...
            <form class="add-pr" action="3D_SHOP/admin/productde.htm"  method="post">
