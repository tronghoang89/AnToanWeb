...
<head>
<meta charset="utf-8">
<title>SANG MINH TRI HOANG SHOP</title>
		...
		<div class="container" >
			...
			<div class="contener1">
                ...
                <div class="navbar-right">
                    ...
                    <button onclick="document.getElementById('cart1').style.display='block'"> <span>${dem}</span><i class="fas fa-shopping-cart"></i></button>
   ...
   <%--  <div class="cart-left1">
    ...
    <footer>
        <div class="footer-cont">
            <container><img src="${pageContext.request.contextPath}/resources/img/logo/gaming_room.jpeg" width ="280" height ="280" alt=""> </container>
            <ul>
                Sản phẩm
