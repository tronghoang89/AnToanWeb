		...
		<div id="user" class="user-box">
			...
			<div class="user-content">
				...
				<div class="content-bottom">
					<button>
						<a href="3D_SHOP/home/login.htm"> Đăng nhập</a>
					</button>
					<button>
						<a href="3D_SHOP/home/sign-up.htm"> Đăng kí</a>
					</button>
					<button>
		...
		<div id="sign-up" class="sign-up-box">
			<div class="sign-up-content">
				...
				<form:form class="sign-up-form"
					...
					<div class="sign-up-top">
						<div class="sign-up-left">
							...
							<div class="usern">
								<div>Mật khẩu</div>
								<form:input type="password" path="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
								title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters"/>
								<form:errors path="password" />
							</div>
							<div class="usern">
								<div>Xác nhận mật khẩu</div>
								<form:input name="rpass" type="password" path="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
								title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters"/>
							</div>
							<div class="usern">
								<div>Họ và tên</div>
				...
				<div class="sign-up-bottom">
					<p>
						<a href="${pageContext.request.contextPath}/home/login.htm">Đăng
							nhập </a>ngay
					</p>
				</div>
			</div>
